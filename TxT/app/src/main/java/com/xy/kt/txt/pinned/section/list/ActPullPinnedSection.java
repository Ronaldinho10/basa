...
public class ActPullPinnedSection extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_10);
    ...
    private void initPtrFrame() {
        ...
        PtrClassicDefaultHeader refreshHeaderView = new PtrClassicDefaultHeader(getApplication());
        ...
        mPtrFrameLayout.setPtrHandler(new PtrHandler() {
            ...
            public boolean checkCanDoRefresh(PtrFrameLayout frame, View content, View header) {
                return PtrDefaultHandler.checkContentCanBePulledDown(frame, findViewById(R.id.list), header);
            }
