...
public class SimpleSectionedGridAdapter extends BaseAdapter implements PinnedSectionGridView.PinnedSectionGridAdapter {
    protected static final int TYPE_FILLER = 0;//item填充空白
    protected static final int TYPE_HEADER = 1;//section 宽度为整行
    protected static final int TYPE_HEADER_FILLER = 2;//section 填充 宽度设置0
        ...
        if (isSectionHeaderPosition(position)) {
            ...
            switch (mSections.get(position).type) {
                case TYPE_HEADER:
                    ...
                    header.setHeaderWidth(screenWidth);
