 ...
 */
public class StickSectionListView extends ListView {
    ...
    public StickSectionListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }

    public StickSectionListView(Context context, AttributeSet attrs, int defStyle) {
    ...
    void createPinnedShadow(int position) {
        ...
        View pinnedView = getAdapter().getView(position, pinnedShadow.view, StickSectionListView.this);
